        ...
        <div className="user-login">
          ...
          {!isOnline && !isMobile && (
            <div className="offline-status-container">
              <div className="offline-status-title">
                <DisconnectedIcon size={16} />
                <span>Offline</span>
              </div>
              <div>Zbugs is read-only until your connection is restored.</div>
            </div>
          )}
                ...
                <div className="logged-in-user">
                  {isMobile ? (
                    <div className="mobile-login-container">
                      ...
                      >
                        {!isOnline && <DisconnectedIcon size={16} />}
                        <AvatarImage
                          user={user}
                      ...
                      >
                        {!isOnline ? (
                          <div className="offline-status-mobile-container">
                            <div className="offline-status-title">
                              <DisconnectedIcon size={16} />
                              <span>Offline</span>
                            </div>
                            <div>
                              Zbugs is read-only until your connection is
                              restored.
                            </div>
                          </div>
                        ) : (
...
const DisconnectedIcon = ({size}: {size: number}) => {
  return (
    <svg
